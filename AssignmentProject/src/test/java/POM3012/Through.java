 ...
 * 
 */
public class ThroughTheForm_Pageshreya {

	public WebDriver driver;
	public WebActionUtil WebActionUtil;
	public long ETO = 10;

	public ThroughTheForm_Pageshreya(WebDriver driver, long ETO, WebActionUtil WebActionUtil) {
		this.driver = driver;
	...
	public synchronized void commonForm(String fromDate, String toDate, String empCode, String countryCode,
		...
		try {
			...
			WebActionUtil.validateEnteredValue(expectedemployeecode, empCode, "Employee code text box",
					empCode+" entered in Employee code text box",empCode+" not entered in Employee code text box", "blue");
	...
	WebActionUtil.waitForElement(txtCountryCode, "Country code text box");
			...
			WebActionUtil.validateEnteredValue(expectedCountryCode, countryCode, "Country code text box",
					countryCode+" entered in Country code text box",countryCode+" not entered in Country code text box", "blue");
			...
			WebActionUtil.validateEnteredValue(expectedCompanyCode, companyCode, "Company code text box",
					companyCode+" entered in Company code text box",companyCode+" not entered in Company code text box","blue");
			...
			WebActionUtil.validateEnteredValue(expectedfromdate, fromDate, "From Date text box",
					fromDate+" entered in from date text box", fromDate+" not entered in from date text box", "blue");
			...
			WebActionUtil.error("Unable to fill the common form for initiating the claim using Through the Form type");
	...
	/**
	 * Description: Method to Number of installments and rate.
	 * 
	 * @author Shreya U
	 * @param numberOfInstallments
	 * @param rate
	 */
	public synchronized void setNoOfInstallmentsAndRate(String numberOfInstallments, String rate) {
		try {
			WebActionUtil.waitForElement(txtNumberOfInstallments, "Number of installments text box");
			WebActionUtil.typeText(txtNumberOfInstallments, numberOfInstallments, "Number of installments text box");
			WebActionUtil.waitForElement(txtRate, "Rate text box");
			WebActionUtil.typeText(txtRate, rate, "Rate text box");
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set number of installments and rate");
			Assert.fail("Unable to set number of installments and rate");
		}
	}

	/**
	 * Description: Method to Number of installments and Periodicity.
	 * 
	 * @author Shreya U
	 * @param numberOfInstallments
	 * @param periodicity
	 */
	public synchronized void setNoOfInstallmentsAndPeriodicity(String numberOfInstallments, String periodicity) {
		try {
			WebActionUtil.waitForElement(txtNumberOfInstallments, "Number of installments text box");
			WebActionUtil.typeText(txtNumberOfInstallments, numberOfInstallments, "Number of installments text box");
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set number of installments and Periodicity");
			Assert.fail("Unable to set number of installments and Periodicity");
		}
	}

	/**
	 * Description: Method to set the Periodicity.
	 * 
	 * @author Shreya U
	 * @param periodicity
	 */
	public synchronized void setPeriodicity(String periodicity) {
		try {
			WebActionUtil.waitForElement(txtPeriodicity, "Periodicity text box");
			WebActionUtil.typeText(txtPeriodicity, periodicity, "Periodicity text box");
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set Periodicity");
			Assert.fail("Unable to set Periodicity");
		}
	}

	/**
	 * Description: Method to set the Bonus period
	 * 
	 * @author Shreya U
	 * @param bonusPeriod
	 */
	public synchronized void setBonusPeriod(String bonusPeriod) {
		try {
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set Bonus Period");
			Assert.fail("Unable to set Bonus Period");
		}
	}

	/**
	 * Description: Method to set the input type
	 * 
	 * @author Shreya U
	 * @param inputType
	 */
	public synchronized void setInputType(String inputType) {
		try {
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set Input Type");
			Assert.fail("Unable to set Input Type");
		}
	}
	...
	/**
	 * Description: Method to set the Payments
	 * 
	 * @author Shreya U
	 * @param payments
	 */
	public synchronized void setPayments(String payments) {
		try {
			WebActionUtil.waitForElement(txtPayments, "Payments text box");
			WebActionUtil.typeText(txtPayments, payments, "Payments text box");

		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set Payments");
			Assert.fail("Unable to set Payments");
		}
	}

	/**
	 * Description: Method to set the type of Payments
	 * 
	 * @author Shreya U
	 * @param payments
	 */
	public synchronized void settypeOfPayments(String payments) {
		try {
			WebActionUtil.waitForElement(txtPaymentType, "Payments type text box");
			WebActionUtil.typeText(txtPaymentType, payments, "Payments type text box");

		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set type of Payments");
			Assert.fail("Unable to set type of Payments");
		}
	}

	/**
	 * Description: Method to set the type of Patent Id
	 * 
	 * @author Shreya U
	 * @param patentId
	 */
	public synchronized void settypeOfPatentId(String patentId) {
		try {
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set the Patent Id");
			Assert.fail("Unable to set the Patent Id");
		}
	}

	/**
	 * Description: Method to set Number of Installments
	 * 
	 * @author Shreya U
	 * @param noOfInstallments
	 */
	public synchronized void setNoOfInstallments(String noOfInstallments) {
		try {
			WebActionUtil.waitForElement(txtNumberOfInstallments, "Number of Installments text box");
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to set number of Installments");
			Assert.fail("Unable to set number of Installments");
		}
	}
	...
	public synchronized void filltheTransportAllowance(String fromDate, String toDate, String empCode,
		...
		try {
			...
			WebActionUtil.validateAttribute(txtInputType, "value", inputType, "Input type text box",
					inputType+" entered in Input type text box ",
					inputType+" not entered in Input type text box", "blue");
			uploadFile(filepath);
	...
	public synchronized void filltheCarParkingDeduction(String fromDate, String toDate, String empCode,
		...
		try {
			...
			WebActionUtil.waitForElement(txtNumberOfInstallments, "Number of installments text box");
			WebActionUtil.typeText(txtNumberOfInstallments, noOfInstallments, "Number of installments text box");
			WebActionUtil.validateAttribute(txtNumberOfInstallments, "value", noOfInstallments, "Number of installments text box",
	...
	public synchronized void fillTheExgratiaLanguageAllowance(String fromDate, String toDate, String empCode,
		...
		try {
			...
			WebActionUtil.validateAttribute(txtRate, "value", rate, "Rate text box",
					rate+" entered in Rate text box ",
					rate+" not entered in Rate text box", "blue");
			uploadFile(filepath);
			validateFileUploaded();
	...
	public synchronized void validateReseteExgratiaLanguageAllowance() {
		try {
			...
			WebActionUtil.validateAttributeIsEmpty(txtRate, "value", "Rate text box",
					"The text entered in Rate text box is reset",
					"The text entered in Rate text box is not reset", "blue");
			validateFileUploaded();
	...
	public synchronized void fillTheExgratiaOther(String fromDate, String toDate, String empCode, String countryCode,
			String companyCode, String amount, String remarks, String noOfInstallments, String filepath) {
		try {
			commonForm(fromDate, toDate, empCode, countryCode, companyCode, amount, remarks);
			WebActionUtil.waitForElement(txtNumberOfInstallments, "Number of installments text box");
			WebActionUtil.typeText(txtNumberOfInstallments, noOfInstallments, "Number of installments text box");
			...
			WebActionUtil.error(e.getMessage());
			WebActionUtil.fail("Unable to fill the Exgratia Other form");
			Assert.fail("Unable to fill the Exgratia Other form");
		}
	}
	/**
	 * Description: Fill the Exgratia Other
	...
	public synchronized void fillTheIkahyaSafetybonus(String fromDate, String toDate, String empCode,
		...
		try {
			...
			WebActionUtil.validateAttribute(txtRate, "value", rate, "Rate text box",
					rate+" entered in Rate text box ",
					rate+" is not entered in Rate text box", "blue");
			uploadFile(filepath);
			validateFileUploaded();
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	public synchronized void fillTheRetentionBonus(String fromDate, String toDate, String empCode, String countryCode,
		...
		try {
			...
			WebActionUtil.waitForElement(txtBonusPeriod, "Bonus Period text box");
			WebActionUtil.typeText(txtBonusPeriod, bonusPeriod, "Bonus Period text box");
			WebActionUtil.validateAttribute(txtBonusPeriod, "value", bonusPeriod, "Bonus Period text box", bonusPeriod+" entered in Bonus Period text box ", bonusPeriod+" not entered in Bonus Period text box", "blue");
	...
	public synchronized void validateResetRetentionBonus() {
		try {
			resetcommonForm();
			WebActionUtil.waitForElement(txtBonusPeriod, "Bonus Period text box");
			WebActionUtil.validateAttributeIsEmpty(txtBonusPeriod, "value", "Bonus Period text box", "The text entered in Bonus Period text box is reset", "The text entered in Bonus Period text box is not reset", "blue");
			validateFileUploaded();
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	public synchronized void fillTheHCLJewels(String fromDate, String toDate, String empCode, String countryCode,
		...
		try {
			...
			WebActionUtil.validateAttribute(txtPaymentType, "value",paymentType , "Payment type text box", paymentType+" entered in Payment type text box", paymentType+" not entered in Payment type text box", "blue");
			uploadFile(filepath);
			validateFileUploaded();
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	public synchronized void validateResetHCLJewel() {
		try {
			resetcommonForm();
		    WebActionUtil.validateAttributeIsEmpty(txtPaymentType,  "value", "Payment type text box", "The text entered in Payment type text box is reset", "The text entered in Payment type text box is not reset", "blue");
			validateFileUploaded();
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	public synchronized void fillThePatentAward(String fromDate, String toDate, String empCode, String countryCode,
		...
		try {
			...
			WebActionUtil.waitForElement(txtPatentID, "Patent Id text box");
			WebActionUtil.typeText(txtPatentID, patentid,"Patent Id text box");
			WebActionUtil.validateAttribute(txtPatentID, "value", patentid, "Patent Id text box", patentid+" entered in Patent Id text box", patentid+" not entered in Patent Id text box", "blue");
			uploadFile(filepath);
			validateFileUploaded();
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	public synchronized void validateResetThePatentAward() {
		try {
			resetcommonForm();
			WebActionUtil.waitForElement(txtPatentID, "Patent Id text box");
			WebActionUtil.validateAttributeIsEmpty(txtPatentID, "value", "Patent Id text box", "The text entered in Patent Id text box is reset","The text entered in Patent Id text box is not reset", "blue");
	...
	//		WebActionUtil.waitForElement(txtPopUpMsg, "Are you sure you want to proceed pop up");
			try {
				new WebDriverWait(driver, 7).until(ExpectedConditions.visibilityOf(popup));
			} catch (Exception e) {

			}
			WebActionUtil.validateisElementDisplayed(txtPopUpMsg, "Are you sure you want to proceed pop up", "Are you sure you want to proceed pop up is displayed", "Are you sure you want to proceed pop up is not displayed", "blue");
		} catch (Exception e) {
			WebActionUtil.error(e.getMessage());
	...
	/**
	 * Description: Validate Claim requests has been successfully raised Toast message
	 * 
	 * @author Shreya U
	 */
	public synchronized void validateClaimSuccessMessage() {
		try {
			...
			WebActionUtil.waitForElement(txtClaimSuccessMsg, "Claim requests has been successfully raised success message");
			WebActionUtil.validateisElementDisplayed(txtClaimSuccessMsg, "Claim requests has been successfully raised success message", "Claim requests has been successfully raised success message is displayed", "Claim requests has been successfully raised success message is not displayed", "green");
/*	try {
		new WebDriverWait(driver,6).until(ExpectedConditions.invisibilityOf(txtClaimSuccessMsg));
	} catch (Exception e) {
		}*/
...
Thread.sleep(2000l);
			WebActionUtil.clickOnElement(btnYes, "Yes Button", "Unable to click on the YES button");
//			if(popup.isDisplayed())
//			{
//				try {
//					new WebDriverWait(driver, 7).until(ExpectedConditions.invisibilityOf(popup));
//				} catch (Exception e) {
//
//				}
//			}
	...
	public synchronized void validateFileUploaded() {
		if (txtfiles.size() > 0) {
			WebActionUtil.validationinfo("The file is uploaded in the file upload text area", "blue");
	...
	public synchronized void resetcommonForm() {
		try {
			...
			WebActionUtil.validateEnteredValue(expectedfromdate, "", "From Date text box",
					"The text entered in From Date text box is reset", "The text entered in From Date text box is not reset ", "blue");
			WebActionUtil.waitForElement(txtToDate, "To Date text box");
			String expectedtodate = WebActionUtil.getTextUsingJS("dtToDate");
			WebActionUtil.validateEnteredValue(expectedtodate, "", "To Date text box", "The text entered in To Date text box is reset",
			...
			WebActionUtil.validateEnteredValue(expectedemployeecode, "", "Employee code text box",
					"The text entered in Employee code text box is reset", "The text entered in Employee code text box is not reset", "blue");
			WebActionUtil.waitForElement(txtCountryCode, "Country code text box");
			String expectedCountryCode = WebActionUtil.getTextUsingJS("vcCountryCode");
			WebActionUtil.validateEnteredValue(expectedCountryCode, "", "Country code text box",
					"The text entered in Country code text box is reset", "The text entered in Country code text box is not reset", "blue");
			WebActionUtil.waitForElement(txtCompanyCode, "Company code text box");
			String expectedCompanyCode = WebActionUtil.getTextUsingJS("vcCompanyCode");
			WebActionUtil.validateEnteredValue(expectedCompanyCode, "", "Company code text box",
					"The text entered in Company code text box is reset", "The text entered in Company code text box is not reset", "blue");
			WebActionUtil.waitForElement(txtAmount, "Amount text box");
			String expectedAmount = WebActionUtil.getTextUsingJS("vcAmount");
			WebActionUtil.validateEnteredValue(expectedAmount, "", "Amount text box", "The text entered in Amount text box is reset",
					"The text entered in Amount text box is not reset", "blue");
			WebActionUtil.waitForElement(txtRemarks, "Remarks text box");
			String expectedRemarks = WebActionUtil.getTextUsingJS("vcRemarks");
			WebActionUtil.validateEnteredValue(expectedRemarks, "", "Remarks text box",
					"The text entered in Remarks text box is reset", "The text entered in Remarks text box is not reset", "blue");
