...
/**
 * Description: Verify that On Site Employee Can Re-initiate the Child Education Claim rejected by L4 For the First Time for Tuition Fees 

 * @author Sajal Jain 
 */
public class TYSS_GIM_0019 extends BaseTest {
		String claimid="24";
			@DataProviderFile(file = "./data/GimTestData.xlsx" , sheet = "TYSS_GIM_0019")
			@Test(dataProvider = "data", dataProviderClass = DataProviderFactory.class)
			public synchronized void TYSS_GIM_0019(String empCode,String ChildName,String AcademicYear,String FromDate,String ToDate,String grade,String Amount,String SchoolName,String Remarks,String fileFormat,String expectedStatusRMLogin,String expectedStatusL2Login,String expectedStatusGeoHrLogin,String expectedStatusES1Login,String expectedStatusES2Login) {
