...
public class DeleteCustomer {
	...
	/*	driver.findElement(By.id("btnAdd")).click();
		...
		/*Delete customer*/
		try {
		driver.findElement(By.xpath("//a[text()='"+getDataFromExcel("Sheet4", 2, 0)+"']/../preceding-sibling::td")).click();
		}catch(Exception e) {
		...
		String actualDeleteMSg = driver.findElement(By.id("Successfully Deleted")).getText();
		String expectedDeleteMsg=getDataFromExcel("Sheet4", 1, 3);
		System.out.println("actual"+actualDeleteMSg);
		System.out.println("expected"+expectedDeleteMsg);
		try {
		Assert.assertEquals(expectedDeleteMsg, actualDeleteMSg);
		System.out.println("Delete Success msg displayed");
		}catch(Exception e) {
			System.out.println("Delete Success msg not displayed");
		}
